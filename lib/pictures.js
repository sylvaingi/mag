...
Pictures.pictureAfter = function(picture){
    return Pictures.findOne({galleryId: picture.galleryId, createdAt:{$gt: picture.createdAt}}, {sort: {createdAt: 1}});
};

Pictures.pictureBefore = function(picture){
    return Pictures.findOne({galleryId: picture.galleryId, createdAt:{$lt: picture.createdAt}}, {sort: {createdAt: -1}});
};
